---
description: Panel yang diukur di laboratorium digunakan untuk mengkalibrasi data yang diambil selama pemrosesan pasca.
metaLinks:
  alternates:
...
Target referensi difus T4 memiliki kurva reflektansi sebagai berikut, [unduh data di sini](https://cdn.shopify.com/s/files/1/0972/5566/files/MAPIR_Diffuse_Reflectance_Standard_Calibration_Target_Data_T4.xlsx?v=1741759157):
...
<figure><img src=".gitbook/assets/MAPIR Diffuse Reflectance Standard Calibration Target Data T4 (400-1000nm).png" alt=""><figcaption><p>MAPIR T4 Reflektansi :: 400-1000 nm</p></figcaption></figure>
